        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">
                        <li><h1 class="logo-wrapper"><a href="{{route('buyerdashboard')}}" class="brand-logo darken-1"><img
                    ...
                    <li class="user-details cyan darken-2">
                        <div class="row">
                            ...
                            <div class="col col s8 m8 l8">
                                ...
                                <p class="user-roal">Property Buyer</p>
                            </div>
                        </div>
                    </li>
                    <li class="bold"><a href='{{ URL::route('buyerdashboard') }}' class="waves-effect waves-cyan"><i class="mdi-action-search"></i> Search Property </a> </li>
                    <li class="bold"><a href='{{ URL::route('plans') }}' class="waves-effect waves-cyan"><i class="mdi-editor-attach-money"></i>Financial Plans</a> </li>
                    <li class="bold"><a href='{{ URL::route('buyerlegaladvisors') }}' class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Legal Advisor </a> </li>
                    <li class="bold"><a href='{{ URL::route('buyerauctions') }}' class="waves-effect waves-cyan"><i
