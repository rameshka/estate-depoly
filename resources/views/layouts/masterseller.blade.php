    ...
    <div class="navbar-fixed">
        <nav class="navbar-color">
            <div class="nav-wrapper">
                <ul class="left">
                    <li><h1 class="logo-wrapper"><a href="{{route('sellerdashboard')}}" class="brand-logo darken-1"><img
        ...
        <aside id="left-sidebar-nav">
            <ul id="slide-out" class="side-nav fixed leftside-navigation">
                <li class="user-details cyan darken-2">
                    <div class="row">
                        <div class="col col s4 m4 l4"><img src="{{URL::asset('images/avatar.jpg')}}" alt=""
                                                           class="circle responsive-img valign profile-image"></div>
                ...
                <li class="bold"><a href='{{ URL::route('sellerdashboard') }}' class="waves-effect waves-cyan"><i
                                class="mdi-action-search"></i> Search Property </a></li>
                <li class="bold"><a href='{{ URL::route('addproperty') }}' class="waves-effect waves-cyan"><i
                                class="mdi-content-add"></i>Add Property</a></li>
                <li class="bold"><a href='{{ URL::route('advertisements') }}' class="waves-effect waves-cyan"><i
                                class="mdi-action-home"></i>My Advertisements</a></li>
                <li class="bold"><a href='{{ URL::route('plans') }}' class="waves-effect waves-cyan"><i
                                class="mdi-editor-attach-money"></i>Financial Plans</a></li>
                <li class="bold"><a href='{{ URL::route('viewlegaladvisors') }}' class="waves-effect waves-cyan"><i
                                class="mdi-social-person"></i> Legal Advisor </a></li>
                <li class="bold"><a href='{{ URL::route('auctions') }}' class="waves-effect waves-cyan"><i
                                class="mdi-action-add-shopping-cart"></i> Auction</a></li>
                <li class="no-padding">
...
@yield('tablejs')
@yield('getloc')
<script src="{{URL::asset('js/view/perfect-scrollbar.min.js')}}"></script>
