        ...
        <div class="row">
            <div class="col s2 m2 l4">
                <div class="card-panel">
                    <h5 style="text-align: center">Decent check House in {!! $property->getCity() !!} for sale</h5>
                </div>
            </div>
        </div>
                        ...
                        <form class="col s12">
                            ...
                            <div class="row">
                                <div class="input-field col s4">
                                    <p><b>Address:</b> {!! $property->getHnumber() !!},{!! $property->getStreet() !!}
                                        ,{!! $property->getClosecity() !!}</p>
                                </div>
                            ...
                            <div class="row">
                                <div class="input-field col s2">
                                    <b>Land Size: (Perches)</b>
                                    <p>{!! $property->getLandarea() !!}</p>

                                </div>

                                <div class="input-field col s2">
                                    <b>Floor area: (Sqft)</b>
                                    <p>{!! $property->getFloorarea()!!}</p>

                                </div>

                                <div class="input-field col s2">
                                    <b>Bed Rooms:</b>
                                    <p>{!! $property->getBeds()!!}</p>
                                </div>

                                <div class="input-field col s2">
                                    <b>Bath Rooms:</b>
                                    <p>{!! $property->getBaths()!!}</p>
                                </div>
