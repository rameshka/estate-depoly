...
<!---------------------------------PDF------------------------------------------------->
    ...
    <link rel="stylesheet" href="{{URL::asset('bookviewer/web/viewer.css')}}">
    ...
    <link rel="resource" type="application/l10n" href="{{URL::asset('bookviewer/web/locale/locale.properties')}}">
                        ...
                        <div id="toolbarViewer">
                            ...
                            <div class="outerCenter">
                                <div class="innerCenter" id="toolbarViewerMiddle">
                                    ...
                                    <span id="scaleSelectContainer" class="dropdownToolbarButton">x
